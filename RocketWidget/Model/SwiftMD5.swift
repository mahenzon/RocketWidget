...
//  Faithfully borrowed from https://github.com/mpurland/SwiftMD5/blob/master/SwiftMD5/SwiftMD5.swift and slightly modified
//
...
public func md5(_ bytes: [Byte]) -> [Byte] {
    // Initialization
    let s: [Word] = [
